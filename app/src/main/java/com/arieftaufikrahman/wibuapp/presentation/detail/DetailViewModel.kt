...
class DetailViewModel @Inject constructor(
    ...
    private suspend fun deleteAnime(data: com.arieftaufikrahman.wibuapp.core.domain.model.Data) {
        animeUseCase.deleteAnime(data = data)
        sideEffect = "Anime Deleted"
    }

    private suspend fun upsertAnime(data: com.arieftaufikrahman.wibuapp.core.domain.model.Data) {
